...
import { AfterViewInit,Output, ChangeDetectorRef, Component, ViewChild, EventEmitter } from '@angular/core';
...
export class AppComponent implements AfterViewInit  {
  ...
  searchKey(source:any){
    this.newsApi.getArticlesByName(source.id)
    .subscribe((res:any)=>{
      this.selectedNewsChannel = source.name
      this.articles = res.articles;
    })
